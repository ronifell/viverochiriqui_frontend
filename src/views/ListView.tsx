  ...
  return (
    <PublicShell>
      <div className="space-y-4">
        ...
        <ul className="space-y-2">
          {items.map((i) => {
            ...
            return (
              <li
                key={i.product_id}
                className="flex items-center gap-3 rounded-2xl bg-white p-3 shadow-soft ring-1 ring-brand-100"
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="line-clamp-1 text-sm font-semibold text-brand-900">
                    {name}
                  </div>
                  {i.pot_size && (
        ...
        <div className="sticky bottom-20 z-10 rounded-2xl bg-brand-700 p-4 text-white shadow-card">
          <div className="flex items-center justify-between">
            <div>
